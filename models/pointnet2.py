...
from torch_geometric.nn import fps, radius, PointNetConv, global_mean_pool
...
class PointNet2Encoder(nn.Module):
    ...
    def forward(self, pos, batch):
        ...
        global_feat = global_mean_pool(x3, batch3)

        # Return final features, positions, corresponding batch indices, and global features
        return x3, pos3, batch3, global_feat
